!(function () {
  ...
  function a(t, n, e) {
    window.fetch &&
      fetch(t, { method: "POST", headers: { "Content-Type": "text/plain" }, keepalive: !0, body: JSON.stringify(n) })
        .then(function (t) {
  ...
  function w() {
    ...
    if (!t && (d < e || i >= 3e3)) {
      d = e;
      var c = { n: "engagement", sd: Math.round((e / n) * 100), d: o.domain, u: l, p: r, e: i, v: 33 };
  ...
  function p() {
    "visible" === document.visibilityState && document.hasFocus() && 0 === u
      ? (u = Date.now())
      : ("hidden" !== document.visibilityState && document.hasFocus()) || ((s = v()), (u = 0), w());
  }
  function v() {
